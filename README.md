🌌 Résumé : Celestial Transportation Experience
🚍 Informations de transport
* Application utilisée : Application de moyen de transport (18+)
* Ville de départ : Non spécifiée
* Ville d’arrivée : Arrêt de bus / station de gare / ville (non spécifié)
* Fréquence du transport :
    * 1 fois
    * 2 fois
    * Ou répété tous les jours (aller-retour)

⚙️ Modes d’expérience
Mode	État	Description
Race Mode	ON/OFF	Permet de s’entraîner à un domaine : sport, musique, programmation
...
Communication mode on/off : avec le  phone d'un pays  /  sms / email / phone call 
IA mode : compte d'une IA fausse photo, créer des posts au début d'une expérience pendant et après une expérience 
